...
const InterviewSetupForm = () => {
  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} className="max-w-4xl mx-auto p-8 space-y-7">
      <div className="flex items-start justify-between gap-4 rounded-xl bg-white/70 border border-[#e2e7ff] px-12 py-10">
        <div>
