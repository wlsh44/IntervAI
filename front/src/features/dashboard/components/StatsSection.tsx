...
const StatsSection = ({ data }: StatsSectionProps) => {
  ...
  return (
    <div className="grid grid-cols-2 gap-4">
      <div className="bg-[#dae2fd] rounded-xl p-4">
        <p className="text-xl font-semibold text-[#131b2e]">{totalCount}회</p>
        <p className="text-sm text-[#131b2e]/60 mt-1">총 면접 횟수</p>
      </div>
      <div className="bg-[#dae2fd] rounded-xl p-4">
        <p className="text-xl font-semibold text-[#131b2e]">{recentDate}</p>
